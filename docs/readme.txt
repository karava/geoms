...
5. Problem: With no meta description
...
6. Problem: Blocked from appearing in search engines
...
Columns:
    1. URL
    2. Page block reason
7. Problem: With a <title> tag that is too long
...
Columns:
    1. URL
    2. Title long
8. Problem: With a <title> tag that is too short
...
Columns:
    1. URL
    2. Title length
9. Problem: With a poorly formatted URL for SEO
